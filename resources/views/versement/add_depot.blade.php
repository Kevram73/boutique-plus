                            ...
                            <div class="col-md-6">
                                <form id="form" action="{{ route('store_depotversement') }}" method="POST" class="form-validate form-horizontal mb-lg" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group mt-lg">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="nature"  id="nature" class="form-control populate" onchange="checkNature()">
...
{{--                                                 <input type="text" name="nature"  id="nature" class="form-control" placeholder="" />
 --}}                                            </div>
                                        ...
                                        <div class="form-group mt-lg" id="solde_c">
                                            <label class="col-sm-3 control-label">Solde Collecteur</label>
                                            <div class="col-sm-9">
                                                <input type="text" id="solde_collecteur" class="form-control" value="{{ $solde }}" readonly/>
                                            </div>
                                        </div>
                                        
                                        <div class="form-group mt-lg">
                                            <label class="col-sm-3 control-label">Nom du deposant</label>
                                            <div class="col-sm-9">
                                                <input type="text" id="nom_deposant" class="form-control" name="nom_deposant"/>
                                            </div>
                                        </div>
...
function sweetToast(type,text){
    ...
    <script>
        var solde = document.getElementById("solde_collecteur").value;
    </script>
    <script>
    function checkNature() {
        var nature = document.getElementById("nature").value;
        var soldeInput = document.getElementById("solde_collecteur");
        var soldeC = document.getElementById("solde_c");
        
        if (nature === "Autres") {
            soldeC.style.display = "none";
        } else {
            soldeC.style.display = "block";
        }
    }
</script>
